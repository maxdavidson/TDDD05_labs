...
public class DataCarrier {
    ...
    private int[]    stateParams = new int[5];
    private String[] stateValues = new String[32];
    ...
    public String getValue() {
        ...
        final int[] values = Arrays.stream(getClass().getDeclaredMethods())
        ...
        // Convert binary array to base-10 integer, representing the state
        final int state = IntStream.range(0, values.length)
                .map(i -> (int) Math.pow(2, i) * values[i])
                .sum();
